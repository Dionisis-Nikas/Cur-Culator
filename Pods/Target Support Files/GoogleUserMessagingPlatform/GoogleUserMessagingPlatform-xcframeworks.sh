...
install_xcframework "${PODS_ROOT}/GoogleUserMessagingPlatform/Frameworks/Release/UserMessagingPlatform.xcframework" "GoogleUserMessagingPlatform" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
